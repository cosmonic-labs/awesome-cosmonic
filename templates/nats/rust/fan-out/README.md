...
wasm-tools component wit target/wasm32-wasip1/release/fan_out.wasm | grep 'export wasmcloud:nats/'
```
...
# and apply.
wash oci push --insecure oci-registry.localhost:8200/nats-fan-out:0.1.0 target/wasm32-wasip1/release/fan_out.wasm
