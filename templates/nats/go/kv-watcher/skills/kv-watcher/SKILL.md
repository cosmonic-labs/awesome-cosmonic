---
name: kv-watcher-go
description: Build, configure, and deploy a KV Watcher component on Cosmonic Desktop against the wasmcloud:nats@0.1.0 driver, in Go. Use when the user wants to react to changes in a NATS KV bucket - put, delete, and purge events.
---
...
```bash
make build
wash oci push --insecure oci-registry.localhost:8200/nats-kv-watcher:0.1.0 kv-watcher.wasm
