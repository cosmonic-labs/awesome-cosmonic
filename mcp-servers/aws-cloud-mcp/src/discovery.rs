...
pub fn document(tools: &[String]) -> String {
    ...
    let document = serde_json::json!({
        ...
        "skills": skills,
        // Credential presence (never values) so Desktop and agents can see
        // what the server needs and whether it is configured.
        "credentials": crate::aws::credentials_json(),
