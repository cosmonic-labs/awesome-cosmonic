...
pub fn document(tools: &[String]) -> String {
    ...
    let document = serde_json::json!({
        ...
        "skills": skills,
        // Credential setup, self-describing (presence only, never values):
        // the secret ref, env var, where to obtain it, and which tool
        // validates it. See mcp-servers/docs/CONVENTIONS.md.
        "credentials": crate::confluence::credentials(),
