...
pub fn document(tools: &[String]) -> String {
    ...
    let document = serde_json::json!({
        ...
        // Layer-1 credential discovery (presence only, never values): which
        // secret ref / env var the server needs and whether it is set.
        "credentials": crate::obsidian::credentials(),
        "capabilities": {
            "tools": tools,
            "resources": {
