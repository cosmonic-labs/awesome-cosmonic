...
pub static SKILLS: &[Skill] = &[Skill {
    ...
    files: &[
        ...
        SkillFile {
            ...
            text: include_str!("../skills/server/references/ENDPOINTS.md"),
            mime_type: "text/markdown",
        },
        SkillFile {
            path: "references/MARKDOWN.md",
            text: include_str!("../skills/server/references/MARKDOWN.md"),
            mime_type: "text/markdown",
        },
        SkillFile {
            path: "references/PROPERTIES.md",
            text: include_str!("../skills/server/references/PROPERTIES.md"),
            mime_type: "text/markdown",
        },
    ],
}];
